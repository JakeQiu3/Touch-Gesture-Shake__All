...
- (void)loadData {
    _fileNameArray = @[@"触摸和移动事件",@"手势事件",@"摇动事件",@"远程事件"].mutableCopy;
    _titileArray = @[@"TouchEventViewController",@"GestureRecognizerViewController",@"ShakeViewController",@"RemoteControlViewController"].mutableCopy;
}
- (void)setUI {
